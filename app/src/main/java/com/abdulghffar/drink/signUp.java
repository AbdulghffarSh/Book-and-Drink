...
public class signUp extends AppCompatActivity
{
    ...
    private void registerUser ()
    {
        ...
        {
            Toasty.warning (signUp.this, "Please enter your E-mail",
        ...
        {
            Toasty.warning (signUp.this, "Please enter your Password",
                    Toast.LENGTH_LONG, true).show ();
            return;
        }
        ...
        {
            Toasty.warning (signUp.this, "Please re-enter your Password ",
                    Toast.LENGTH_LONG, true).show ();
            return;
        }
        ...
        {
            Toasty.error (signUp.this, "The two Passwords do not match",
                    Toast.LENGTH_LONG, true).show ();
            return;
        }
        ...
        {
            Toasty.warning (signUp.this, "Please enter your name",
                    Toast.LENGTH_LONG, true).show ();
            return;
        }
        ...
        {
            Toasty.warning (signUp.this, "Please enter your Phone Number",
                    Toast.LENGTH_LONG, true).show ();
            return;
        }
        if (radioGroup.getCheckedRadioButtonId () == -1)
        {
            Toasty.warning (signUp.this, "Please choose your gender",
                    Toast.LENGTH_LONG, true).show ();
            return;
        }
        mAuth.createUserWithEmailAndPassword (emailText,
                passwordText).
                                ...
                                if (task.isSuccessful ())
                                {
                                    ...
                                    UserProfileChangeRequest profileUpdates =
                                            new UserProfileChangeRequest.Builder ().
                                                    setDisplayName (fullNameText).build ();
                                    assert newUser != null;
    ...
    private void writeNewUser (FirebaseUser newUser)
    {
        ...
        assert newUser != null;
        User user =
                new User (newUser.getUid (), email.getText ().toString (),
                        fullName.getText ().toString (),
                        phoneNumber.getText ().toString (), genderText, null, null);
